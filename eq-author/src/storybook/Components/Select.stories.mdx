...
<Canvas>
  <Story name="Primary">
    <Form htmlWidth="50%">
      <Label htmlFor="favorite-jedi">Unit of length</Label>
      <Select id="favorite-jedi">
...
<Canvas>
  <Story name="Loading">
    <Form htmlWidth="50%">
      <Label htmlFor="favorite-sith">Unit of length</Label>
      <Select id="favorite-sith" loading>
        <option selected hidden></option>
      </Select>
    </Form>
  </Story>
...
Dropdowns aren’t very accessible. If you have to use them, make sure you support keyboard input to navigate within them.
