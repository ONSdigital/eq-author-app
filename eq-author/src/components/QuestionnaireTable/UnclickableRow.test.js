...
describe("UnclickableRow", () => {
  ...
  it("should handle button focus state change correctly", () => {
    const wrapper = shallow(<UnclickableRow {...props} />);
  ...
  it("should not navigate to the questionnaire when the row is clicked", () => {
    const wrapper = shallow(<UnclickableRow {...props} />);
  ...
  it("should not navigate to the questionnaire when clicking the link", () => {
    const wrapper = shallow(<UnclickableRow {...props} />);
    const tableLink = wrapper.find(QuestionnaireItem);
    const stopPropagation = jest.fn();
  ...
  it("should allow duplication of a Questionnaire", () => {
    let wrapper = shallow(<UnclickableRow {...props} />);
    const stopPropagation = jest.fn();
    wrapper
  ...
  it("should show the short title when it is provided", () => {
    ...
    wrapper = shallow(<UnclickableRow {...props} />);
